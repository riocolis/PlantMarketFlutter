...
const String imgillustrationDelivery = 'assets/illustration_delivery.png';
const String imgillustrationOrders = 'assets/illustration_orders.png';
const String imgillustrationSuccessSignUp =
    'assets/illustration_success_signup.png';

const String titleSignIn = 'Sign In';
const String titleSignUp = 'Sign Up';
const String titleAddress = 'Address';
const String titleHomePage = 'Plant Market';
